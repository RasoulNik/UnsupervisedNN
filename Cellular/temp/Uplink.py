...
from libs_uplink.Data0 import Data
from libs_uplink.Plot_results import Plot

# from UNNdebug import UNN
from libs_uplink.UNN_Uplink import UNN
...
#---------------------------------------------
data=Data(Nuser)
theta = .7 # a good benchmark for max-product cost
theta = .4 # a good benchmark for maxmin cost
G_batch,p_frac=data(2*batch_size,theta)
...
if load:
   ...
   path= os.path.join(current_dir, '../Downlink/models_trained', 'maxminUNN_20200826-141651.mod')
